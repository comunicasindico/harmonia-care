...
function obterNomeProfissional(tipo="normal"){
const nome=localStorage.getItem("usuario_nome")||localStorage.getItem("nome_apelido")||localStorage.getItem("usuario")||"admin"
